...
const App = () => {
  ...
  const hubEndpoint = "https://olympicmedalsbackend.azurewebsites.net/medalsHub"
  const usersEndpoint = "https://olympicmedalsbackend.azurewebsites.net/api/Users/login";
  ...
  return (
    ...
    <Navbar className="navbar-dark bg-dark">
        <Container fluid>
          <Navbar.Brand>
           Elijah's Finial Olympic Medals
