...
import { TrashFill, FolderPlus, Trash3, } from 'react-bootstrap-icons';
        ...
        <Card.Title className="d-flex justify-content-between">
          ...
          { renderSaveButton() ?
            <React.Fragment>
              ...
              <Trash3 onClick={ () => onReset(country.id) } className='icon-btn' />
              <FolderPlus onClick={ () => onSave(country.id) } className='icon-btn' />
